...
#		  return json.loads(tmp_dic,object_hook=_decode_list)

def json_dumps_unicode_to_string(data):
	if type(data) is list:
		data = _decode_list(data)
...
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.contact_list),_indent=4))
#			  with open('special_list.json', 'w') as f:
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.special_list),_indent=4))
#			  with open('group_list.json', 'w') as f:
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.group_list),_indent=4))
#			  with open('public_list.json', 'w') as f:
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.public_list),_indent=4))
#			  with open('member_list.json', 'w') as f:
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.member_list),_indent=4))
#			  with open('group_users.json', 'w') as f:
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.group_members),_indent=4))
#			  with open('account_info.json', 'w') as f:
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.account_info),_indent=4))
#
		if self.DEBUG:
			with open('contact_list.json', 'w') as f:
#				  print unicode_to_str(self.contact_list)
#				  print json.dumps(unicode_to_str(self.contact_list),indent=4,ensure_ascii=False,sort_keys=True)
				
#				  print type(self.contact_list)
#				  for i in self.contact_list:
#					  print i
#					  time.sleep(1)
#				  print json.dumps(str(self.contact_list).encode("UTF-8"),indent=4)
#				  print self.contact_list
#				  print json_loads_unicode_to_string(self.contact_list)

				f.write(json_dumps_unicode_to_string(self.contact_list))
#				  sys.exit()
			with open('special_list.json', 'w') as f:
				f.write(json_dumps_unicode_to_string(self.special_list))
			with open('group_list.json', 'w') as f:
				f.write(json_dumps_unicode_to_string(self.group_list))
			with open('public_list.json', 'w') as f:
				f.write(json_dumps_unicode_to_string(self.public_list))
			with open('member_list.json', 'w') as f:
				f.write(json_dumps_unicode_to_string(self.member_list))
			with open('group_users.json', 'w') as f:
				f.write(json_dumps_unicode_to_string(self.group_members))
			with open('account_info.json', 'w') as f:
				f.write(json_dumps_unicode_to_string(self.account_info))
...
#				  f.write(json_dumps_unicode_to_string(json_loads_unicode_to_string(self.account_info),_indent=4))
	...
	def handle_msg(self, r):
		...
		:return: None
		"""
		print json_dumps_unicode_to_string(r)
...
#			  print node + "fuck" + "\n"
	...
	def init(self):
		...
		r.encoding = 'utf-8'
		dic = json.loads(r.text)
		a = json.dumps(dic,indent=4)
		with open("/tmp/info_of_wx.json","a+") as b:
